...
var accept = function (container, ui) {
    ...
    if ($(ui.draggable).hasClass('submission')) {
        data = {action : 'accept', id_ : get_draggable_id(ui.draggable)};
        $.post('ajax', data,
            function (result) {
        ...
        data = {action : 'unpublish', id_ : get_draggable_id(ui.draggable)};
        $.post('ajax', data,
            function (result) {
                ui.draggable.addClass('accepted')
                    .removeClass('trashed published submission');
...
var undo = function (container, ui) {
    ...
    if ($(ui.draggable).hasClass('trashed')) {
        data = {action : 'unreject', id_ : get_draggable_id(ui.draggable)};
        $.post('ajax', data,
            function (result) {
        ...
        data = {action : 'unaccept', id_ : get_draggable_id(ui.draggable)};
        $.post('ajax', data,
            function (result) {
